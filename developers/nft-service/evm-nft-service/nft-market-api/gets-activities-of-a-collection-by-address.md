---
description: GET /chains/{chainId}/contractAddress/{contractAddress}/myActivity
---

# 🔥 Gets activities of a Collection By Address

**Query Parameters:**

* `address <stirng>` - Activity-related address
* `activityType <string, optional>` - What types of activities do you want to filter. If not set, all types of data are returned by default
  * transfer
  * mint
  * unlist
  * list
  * sale&#x20;
* `page: <number, optional>` - If not set,`1` by default
* `limit: <number, optional>` - Limit the number of records on a page. If not set,`100` by default
