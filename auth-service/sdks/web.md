...
| :------------------: | :-------------------------------------------------------------------------------------------------------------------------------------------------------: | :----: | :------: |
| <p>accountId<br></p> |                                                    Unique identifier for a user on the partner’s system                                                   | string |   False  |
|      clientType      |                                                          \[web,android,ios,extension],default web                                                         | string |   False  |
...
|    merchantOrderId   |                Orderid.This value will be generated by the partner and needs to be unique.You can query the order details based on this id                | string |   False  |
|       tradeType      |                                                                        buy or sell                                                                        |        |          |
|      hideAddress     |                                               Whether to display the wallet address in the user,Default true                                              | string |   False  |
|     walletAddress    |                                                      Wallet address for the predefined cryptocurrency                                                     |  bool  |   False  |
|         memo         | Buy order-specific. Wallet address tag/memo of type string. This is required when sending wallet address for cryptocurrency(e.g. BNB (Memo) or XRP (Tag)) | string |   False  |
|     refundAddress    |                                      Wallet address for the predefined cryptocurrency . It is used for refund in sell                                     | string |   False  |
|      refundMemo      |                 Sell order-specific. Wallet address tag/memo of type string. This is required when refunding(e.g. BNB (Memo) or XRP (Tag))                | string |   False  |
|      addressSign     |                                      provides HMAC-SHA-256 signature for address.Prevent address from being changed.                                      | string |   False  |
