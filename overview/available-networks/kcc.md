---
description: >-
  Empower Your KCC Development with Particle SDK: Build Fast and Cost-Effective
  dApps on a Secure and Ethereum-Compatible Platform
---
...
* High Performance: KCC offers high throughput and fast transaction speeds, enabling responsive and efficient dApps.
* Ethereum Compatibility: KCC is compatible with Ethereum's development tools and dApp ecosystem, simplifying the migration or interaction with Ethereum-based projects.
* Community-driven Governance: KCC has a community-driven governance model that encourages collaboration and active participation from its users and developers.
* Low Transaction Fees: KCC's efficient design results in low transaction fees, making it an affordable option for developers and users.

### **Chain Information**

{% embed url="https://docs.kcc.io/" %}
...
### **Particle Network Middleware Solution: Advantages for KCC Developers**
...
* **Cross-Chain and Cross-Platform Compatibility**: Particle Network services support multiple chains and platforms, allowing you to reach a diverse user base and provide a consistent experience on KCC and beyond.
