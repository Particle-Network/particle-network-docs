---
description: >-
  Unleash the Power of Privacy-Preserving dApps with Particle SDK on PlatON:
  Build Secure and Efficient dApps for the Future of Data Collaboration
---
...
* Privacy-Preserving Technology: PlatON incorporates advanced cryptographic techniques, such as Zero-Knowledge Proof and Secure Multi-Party Computation, to protect user privacy and data security.
* Scalable Consensus Mechanism: PlatON employs a scalable consensus mechanism called Verifiable Random Function (VRF)-based Byzantine Fault Tolerance (BFT), which ensures high throughput and fast transaction speeds.
* Cross-Chain Compatibility: PlatON's cross-chain infrastructure connects with other major blockchains, promoting cross-chain collaboration and asset transfers.
* Developer-friendly Ecosystem: PlatON offers a range of development tools and resources for building privacy-preserving dApps, fostering innovation and collaboration in its ecosystem.

### **Chain Information**

{% embed url="https://devdocs.platon.network/docs/en/" %}
Official Documentation
{% endembed %}

| chainId (int) | chainName (string) | EVM Chains     |
| ------------- | ------------------ | -------------- |
| 321           | platon             | PlatON Mainnet |
| 322           | platon             | PlatON Testnet |
...
### **Particle Network Middleware Solution: Advantages for PlatON Developers**
...
* **Cross-Chain and Cross-Platform Compatibility**: Particle Network services support multiple chains and platforms, allowing you to reach a diverse user base and provide a consistent experience on PlatON and beyond.
