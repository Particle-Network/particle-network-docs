---
description: >-
  Enhance Your Oasis Emerald dApp Development with Particle SDK: Build
  Privacy-Preserving, High-Performance Decentralized Applications
---
...
* Privacy-Preserving: OasisEmerald employs advanced privacy-preserving techniques to protect user data and enable the development of confidential dApps.
* Scalable Architecture: OasisEmerald's architecture is designed to support high throughput and fast transaction speeds, enabling the development of large-scale and complex dApps.
* Energy-Efficient Consensus: OasisEmerald uses a Proof-of-Stake (PoS) consensus mechanism, which is more energy-efficient compared to traditional Proof-of-Work (PoW) systems.
* Growing Ecosystem: OasisEmerald has a growing ecosystem of dApps across various industries, including DeFi, NFTs, and gaming, fostering innovation and collaboration.

### **Chain Information**

{% embed url="https://docs.oasis.io/dapp/emerald/writing-dapps-on-emerald/" %}
...
### **Particle Network Middleware Solution: Advantages for OasisEmerald Developers**
...
* **Cross-Chain and Cross-Platform Compatibility**: Particle Network services support multiple chains and platforms, allowing you to reach a diverse user base and provide a consistent experience on OasisEmerald and beyond.
