---
description: >-
  Empower Your Aurora Development with Particle SDK: Create Advanced dApps on a
  Scalable, Low-Cost Ecosystem with Seamless Ethereum Compatibility
---
...
* Ethereum Compatibility: Aurora offers full compatibility with Ethereum's development tools and dApp ecosystem, facilitating seamless integration and migration.
* Near Protocol Integration: Aurora leverages Near Protocol's advanced technology, benefiting from its scalability, security, and energy efficiency.
* High Performance: Aurora supports high throughput and fast transaction speeds, providing a responsive and efficient environment for dApps.
* Low Transaction Fees: Aurora's efficient design results in low transaction fees, making it an affordable option for developers and users.

### **Chain Information**

{% embed url="https://doc.aurora.dev/" %}
...
### **Particle Network Middleware Solution: Advantages for Aurora Developers**
...
* **Cross-Chain and Cross-Platform Compatibility**: Particle Network services support multiple chains and platforms, allowing you to reach a diverse user base and provide a consistent experience on Aurora and beyond.
